...
def date_to_ut(date) -> float:
    ...
    beginning_of_day = datetime(date.year, date.month, date.day, 00, 00, 00, 00, \
                                tzinfo=timezone.utc)
...
def date_to_sidereal(date) -> float:
    ...
    sidereal_beginning_of_day = 24110.54841 + 8640184.812866 * T0 \
                                + 0.093104 * T1**2 - 0.0000062 * T1**3
